...
import 'package:mumcareapp/utils/read_more.dart';
import 'package:mumcareapp/utils/ui_helper.dart';

class ArticlesDetailPage extends StatefulWidget {
  final Choice event;
  ArticlesDetailPage(this.event, );
  @override
  _ArticlesDetailPageState createState() => _ArticlesDetailPageState();
}

class _ArticlesDetailPageState extends State<ArticlesDetailPage> with TickerProviderStateMixin {
  Choice event;
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            if (hasTitle) Text(event.title, style: titleStyle.copyWith(color: Colors.white)),
            Card(
              shape: CircleBorder(),
              elevation: 0,
              child: InkWell(
